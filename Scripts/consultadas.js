...
// consulta com filtro, projeção e uso de express�o regular - numero de telefone da paciente que possui Stella no nome
db.Pessoas.find({tipo: "pacientnão nome: /Stella/}, {telefone:1, _id:0});
