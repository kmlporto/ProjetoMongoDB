...
// Pessoas que trabalham na clinica, e que não possuem endereço cadastrado
db.Pessoas.find({tipo: {$in: ["dentista", "funcionario"]}, endereço: {$exists: false}});
...
// nome e numero de telefone de funcionarios que não possuem endereço cadastrado
db.Pessoas.find({tipo:"funcionario" , endereço: {$exists:false}},
                {nome:1, telefone:1, _id:0});

// nome e endereço da paciente que possui numero de teleone (83) 99598-6095
db.Pessoas.find({"telefone": {$in: ["(83) 99598-6095"]}}, 
                {nome:1, endereço:1, _id:0});
...
db.Pessoas.find({tipo:"paciente", "endereço.bairro":"Gramame"});
...
// consulta que use distinct ou limit - mostrar 5 pessoas que não possuem cadastro de endereço
db.Pessoas.find({endereço: {$exists:false}},
